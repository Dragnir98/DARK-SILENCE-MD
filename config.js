...
module.exports = {
    ...
    CAPTION: process.env.CAPTION || "🧛‍♂️MɌX🩸 ĐȺɌꝀ🐦‍🔥 𝔇ℜ𝔄𝔊𝔑ℑℜ👀🧛🏻‍♂️",
    ...
    ALIVE_MSG: process.env.ALIVE_MSG || "HII DEAR IM ONLINE I'M MRX DARK 𝐃𝐑𝐀𝐆𝐍𝐈𝐑 😊♻️",
    ...
    OWNER_NAME: process.env.OWNER_NAME || MRX DARK DRAGNIR ࿐",
    READ_CMD: process.env.READ_CMD || "true",
    BOT_NAME: process.env.BOT_NAME || "➺🧛‍♂️MɌX🩸 ĐȺɌꝀ🐦‍🔥 𝔇ℜ𝔄𝔊𝔑ℑℜ👀🧛🏻‍♂️",
    STATUS_REPLY: process.env.STATUS_REPLY || "`➺үσυя sтαтυs sεεη נυsт ησω вү MRX ∂αяк-𝐃𝐑𝐀𝐆𝐍𝐈𝐑`",
