...
module.exports = {
    ...
    ALIVE_IMG: process.env.ALIVE_IMG || "https://github.com",
    ALIVE_MSG: process.env.ALIVE_MSG || "HII DEAR IM ONLINE IM MRX😊♻️",
    ...
    STATUS_REPLY: process.env.STATUS_REPLY || "`➺үσυя sтαтυs sεεη נυsт ησω вү MR AFRIKEN`",
